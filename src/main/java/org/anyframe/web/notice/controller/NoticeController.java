package org.anyframe.web.notice.controller;

import org.anyframe.web.notice.model.Notice;
...
public class NoticeController {
    ...
    public List<Notice> listNotice() {
        ...
        noticeList.add(new Notice(1, "[알림] 서버 정기 작업 일정 알려드립니다. ( 10/1(수) 15:00 ~ 10/1(수) 18:00 )", "10/1(수) 15:00 ~ 10/1(수) 18:00 로 예정된 서버 정기 작업 일정을 알려드립니다.<br/>" +
                "이 시간 동안 Anyframe Java 오픈소스 커뮤니티 사용을 포함하여 Anyframe Java 개발 서버를 통해 제공하는 개발 환경에 접근이 제한되므로 사용에 참고하시기 바랍니다.<br/>" +
                "<br/>" +
                "[작업 일시]<br/>" +
                "10/1(수) 15:00 ~ 10/1(수) 18:00<br/>" +
                "<br/>" +
                "[사용 제한 대상]<br/>" +
                "1) Anyframe Java 오픈소스 커뮤니티 사이트(다운로드 페이지, 매뉴얼 사이트, Forum 등 모두 제한됨)<br/>" +
                "2) Subversion(형상관리 서버)<br/>" +
                "3) CTIP(빌드 서버)<br/>" +
                "4) JIRA(이슈 관리 시스템)<br/>" +
                "5) Anyframe Maven Repository(라이브러리 저장소)<br/>" +
                "<br/>" +
                "문의사항이 있으신 경우 관리자 이메일(anyframe@samsung.com)로 연락주시기 바랍니다.<br/>" +
                "<br/>" +
